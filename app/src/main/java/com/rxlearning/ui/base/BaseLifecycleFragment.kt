...
import com.rxlearning.KEYBOARD_VISIBLE_THRESHOLD_DP
import com.rxlearning.R
import com.rxlearning.ui.base.dialog.DialogFragmentCallback
...
abstract class BaseLifecycleFragment<T : BaseViewModel> : Fragment(), BaseView, DialogFragmentCallback {
    ...
    fun ImageView.switchEye(isActive: Boolean) {
        imageResource = if (isActive) R.drawable.ic_eye_blue_active_24dp else R.drawable.ic_eye_blue_normal_24dp
    }
